...
function VerticalIcon(props: LayoutIconProps) {
    ...
    return (
        <svg width={s()} height={s()} viewBox="0 0 40 40" fill="none" class={props.class}>
            {/* Left column - Team 1 */}
            {/* Ban accent bar */}
                ...
                {(sec) => (
                    <>
                        <rect
                            ...
                            fill={sec.color}
                        />
                        <For each={slotIndexes(sec.count)}>
                            {(i) => (
                                <>
                                    <rect
                                        x="10"
...
const layoutIconMap: Record<
    CardLayout,
    (props: LayoutIconProps) => ReturnType<typeof VerticalIcon>
> = {
