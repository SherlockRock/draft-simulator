                    ...
                    <form onSubmit={handleSubmit} class="space-y-4">
                        ...
                        <div>
                            ...
                            <button
                                ...
                                class="flex h-16 w-full items-center gap-3 rounded border border-darius-border bg-darius-card-hover px-3 py-2 text-darius-text-primary hover:bg-darius-card"
                            >
                                <Show
                                    when={icon()}
                                    fallback={
